 ...
 return (
  ...
  <div className="header">
     ...
     <div className="header__right">
       ...
       <a href="https://farishjamal.online"><i className="fa fa-github" aria-hidden="true"></i> </a>
       <a href="/"><i className="fa fa-instagram" aria-hidden="true" style={{color:"#8a3ab9"}}></i> </a>
